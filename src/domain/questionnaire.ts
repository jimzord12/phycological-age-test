...
function q(
  ...
  return {
    ...
    dimension,
    prompt,
    options: [...options.map(([oid, label, score]) => ({ id: oid, label, score })), NOT_APPLICABLE],
  };
}
...
export const STRUCTURED_QUESTIONS: readonly StructuredQuestion[] = [
  ...
  q(
    "ER01",
    "ER",
    "Think of the last criticism that stayed with you after the conversation. What did you actually do first?",
    [
      ["A", "I responded before I had fully understood what they meant.", 1],
      [
        "B",
        "I defended myself point by point, then later noticed that I had missed part of the criticism.",
        2,
      ],
      [
        "C",
        "I asked for a concrete example, paused, and responded after I understood the specific claim.",
        5,
      ],
      [
        "D",
        "I said very little, but replayed the conversation and avoided the person afterward.",
        2,
      ],
      [
        "E",
        "I acknowledged the useful part and directly challenged the part I believed was unfair.",
        4,
      ],
    ],
  ),
  q(
    "ER02",
    "ER",
    "During the last emotionally intense situation you remember clearly, how accurately could you identify what you were feeling?",
    [
      ["A", "I mainly knew that I felt bad, stressed, or overwhelmed.", 1],
      ["B", "I identified the broad emotion several hours later.", 2],
      [
        "C",
        "I could distinguish the specific emotion and what it was pushing me to do while it was happening.",
        5,
      ],
      [
        "D",
        "I identified the emotion quickly and treated it as proof that my interpretation was correct.",
        3,
      ],
      [
        "E",
        "My first label was incomplete, but I revised it after noticing more of what was going on.",
        4,
      ],
    ],
  ),
  q(
    "ER03",
    "ER",
    "After the last conflict that genuinely affected you, what best describes your recovery?",
    [
      ["A", "I appeared normal quickly and did not think about it again.", 3],
      [
        "B",
        "I took deliberate steps to settle, then returned to the issue with a clearer view.",
        5,
      ],
      [
        "C",
        "It affected me for a day or more, but I continued functioning and eventually processed it.",
        3,
      ],
      [
        "D",
        "I replayed it for days and repeatedly reopened the argument in my head or with other people.",
        1,
      ],
  ...
  q(
    "ER04",
    "ER",
    "Think of the last time your behavior hurt or unfairly affected someone. What happened next?",
    [
      ["A", "I apologized, but spent most of the conversation explaining what I intended.", 2],
      [
        "B",
        "I waited for them to raise it again because I did not want to make the situation worse.",
        1,
      ],
      [
        "C",
        "I named what I did, acknowledged the likely impact, and asked what repair would be useful.",
        5,
      ],
      [
        "D",
        "I apologized quickly to end the tension, but did not change the repeated behavior.",
        2,
      ],
      [
        "E",
        "I accepted the part that was mine, disagreed with what was not mine, and changed one concrete behavior.",
        4,
      ],
    ],
  ),
  q(
    "ER05",
    "ER",
    "In the last high-pressure situation where strong emotion could have affected an important decision, what did you do?",
    [
      [
        "A",
        "I suppressed the emotion completely until the task was over, then made time to process it.",
        4,
      ],
  ...
  q(
    "IC01",
    "IC",
    "The last time you wrote a message while angry, hurt, or anxious, what did you do?",
    [
      ["A", "I sent it while the emotion was still at its peak.", 1],
      [
        "B",
        "I drafted it, waited at least twenty minutes, and reviewed whether the message still served my goal.",
        4,
      ],
      [
        "C",
        "Because it was not urgent, I waited until the next day and then decided whether to send anything.",
        5,
      ],
      ["D", "I did not send it, but later expressed the same anger indirectly.", 2],
      [
        "E",
        "I rewrote it repeatedly because I was trying to eliminate every possible negative reaction.",
        3,
      ],
    ],
  ),
  q(
    "IC02",
    "IC",
    "When a repeated temptation conflicts with a longer-term goal, which pattern best matches what you have actually done?",
    [
      ...
      [
        "D",
        "I sometimes choose the reward deliberately and accept the cost without pretending it was accidental.",
        4,
      ],
  ...
  q(
    "IC03",
    "IC",
    "Think of the last difficult task that stopped progressing. What did you do after the first few failed attempts?",
    [
      ["A", "I switched to something easier and did not return.", 1],
      [
        "B",
        "I forced myself through it while getting increasingly angry, and the quality dropped.",
        2,
      ],
      [
        "C",
        "I broke the problem into smaller parts, tried a different route, and returned with new information.",
        5,
      ],
  ...
  q(
    "IC04",
    "IC",
    "The last time you were likely to miss a meaningful commitment, what did you do?",
    [
      ...
      [
        "D",
        "I communicated early, renegotiated honestly, and accepted the inconvenience caused.",
        4,
      ],
      [
        "E",
        "I quietly dropped a lower-priority promise because I had accepted too many commitments.",
        2,
      ],
    ],
  ),
  q(
    "IC05",
    "IC",
    "Think of the last consequential decision that felt urgent but was not an emergency. What best describes your process?",
    [
      ...
      [
        "C",
        "I gathered the minimum information needed, set a decision deadline, and chose deliberately.",
        5,
      ],
      [
        "D",
        "I handed the decision to someone else because I did not want responsibility for the outcome.",
        2,
      ],
  ...
  q(
    "PT01",
    "PT",
    "During the last disagreement with someone you respect, what did you actually do?",
    [
      ...
      [
        "E",
        "I identified the strongest part of their case while keeping my original conclusion.",
        4,
      ],
    ],
  ),
  q(
    "PT02",
    "PT",
    "Think of the most recent time you changed your mind about something that mattered. What caused the change?",
    [
  ...
  q(
    "PT03",
    "PT",
    "When the available evidence supports more than one plausible explanation, which pattern is closest to your own?",
    [
      ...
      [
        "C",
        "I hold multiple explanations and deliberately look for evidence that could disprove each one.",
        5,
      ],
  ...
  q("PT04", "PT", "The last time useful feedback was delivered badly, what did you do?", [
    ...
    [
      "E",
      "I asked for a concrete example and tested whether the claim matched a broader pattern.",
      4,
    ],
  ]),
  q("PT05", "PT", "When someone recently disappointed you, what explanation did you begin with?", [
    ...
    [
      "C",
      "I considered both situational and personal explanations and looked for information before deciding.",
      5,
    ],
    [
      "D",
      "I chose the most charitable explanation even though the behavior crossed a boundary.",
      3,
    ],
  ...
  q(
    "IS01",
    "IS",
    "Think of the last time your view differed from a group whose approval mattered to you. What did you do?",
    [
      ...
      [
        "D",
        "I stayed quiet in the moment but made the later decision according to my own priorities.",
        4,
      ],
  ...
  q(
    "IS02",
    "IS",
    "After the last piece of negative feedback from someone important to you, what happened to your view of yourself?",
    [
      ...
      [
        "C",
        "I compared it with evidence, my values, and other observations before deciding what it meant.",
        5,
      ],
      ["D", "I asked several people for reassurance until I felt stable again.", 2],
      [
        "E",
        "I accepted the useful part without turning it into a global judgment about myself.",
        4,
      ],
    ],
  ),
  q(
    "IS03",
    "IS",
    "Around a person or group you perceived as high-status, what did you notice yourself doing most recently?",
    [
  ...
  q(
    "IS04",
    "IS",
    "Think of a recent decision where your own priorities conflicted with what other people expected. What did you do?",
    [
      ...
      [
        "C",
        "I named the trade-off and chose according to priorities I had already considered important.",
        5,
      ],
  ...
  q(
    "TD01",
    "TD",
    "In a recent meaningful decision, how far ahead did you genuinely consider the consequences?",
    [
      ...
      [
        "D",
        "I prioritized the distant future so strongly that present needs received too little weight.",
        3,
      ],
  ...
  q(
    "TD02",
    "TD",
    "When planning something important with uncertain conditions, which approach best matches your recent behavior?",
    [
      ...
      [
        "D",
        "I chose a direction and scheduled a checkpoint rather than pretending to know the full path.",
        4,
      ],
  ...
  q(
    "TD03",
    "TD",
    "Think of a goal that produced little visible progress for several weeks. What did you do?",
    [
      ...
      [
        "C",
        "I tracked leading indicators, reviewed the method, and adjusted while preserving the goal.",
        5,
      ],
      ["D", "I reduced the pace to something sustainable and continued.", 4],
      [
        "E",
        "I invested more time even when it was damaging health, relationships, or other commitments.",
        3,
      ],
    ],
  ),
  q(
    "TD04",
    "TD",
    "When you think about limited time or mortality, how does it affect actual decisions?",
    [
  ...
  q(
    "TD05",
    "TD",
    "Which statement best matches how you handled a recent choice between present enjoyment and future security?",
    [
      ["A", "I chose the present benefit and assumed my future self would handle the cost.", 1],
      [
        "B",
        "I denied the present need because future security felt more important than almost anything else.",
        3,
      ],
      ...
      [
        "E",
        "I prioritized according to the size, reversibility, and timing of the consequences.",
        4,
      ],
    ],
  ),
